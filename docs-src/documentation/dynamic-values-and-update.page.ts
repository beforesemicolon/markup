...
const page = TemplatingGroup.list[6]
...
export default DocPageLayout(
    ...
    html`
        ...
        <p>
            ...
            <a href="./event-handling">event handler</a>, will be called to get
            the value to render or for an attribute.
        </p>
        <p>
            The example bellow will render the count just fine but using a
            function to return the value tells the template that the value might
        ...
        <p>
            ...
            about <a href="./state-values">states</a> in the future. For now,
            let's focus on the function alone.
        </p>
        ${Heading('Update template', 'h3')}
        <p>
            Just having dynamic values in the template does not do much. All it
            does is render the value correctly.
        </p>
        <p>
        ...
        <ol>
            <li>
                <code>countUp</code>: used as <code>click</code> event listener
                on the button.
            </li>
            <li>
                <code>counter.update</code>: used to tell the template the about
                the value change.
            </li>
        </ol>
        <p>
            The <code>update</code> is another method the template instance
            exposes which you can use to tell it to look into all those dynamic
            values and rerun them. The template will get a new value, do a
            <em>shallow comparison</em> and update the DOM if such value has
            changed.
        </p>
        <p>
            <strong>Important to know</strong> that this "re-check" happens to
            all dynamic values in the template. This means that you can update
            multiple values at once and call the <code>update</code> after to
            have the template update for all of them.
        </p>
        <p>
