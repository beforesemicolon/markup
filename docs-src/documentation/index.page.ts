...
export default ({ page, nextPage, prevPage, docsMenu }: PageComponentProps) =>
    DocPageLayout(
        ...
        html`
            ${Heading(page.name)}
            <p>
                A reactive HTML templating system that can be used in any
                JavaScript environment, client or server.
            </p>
            <ul>
                <li>
                    <strong>Reactive</strong>: The template will react to all
                    and specific state or data change to update where is needed
                    only.
                </li>
                <li>
                    <strong>Independent</strong>: The template does not depend
                    on any setup or extension in order to accomplish really
                    complex things. It is plug-and-play, ready to go anywhere.
                </li>
                <li>
                    <strong>Fast</strong>: It uses one of the fastest HTML
                    parser and the algorithm is designed to only run code
                    related to the things that changed which allows for really
                    fast updates.
                </li>
                <li>
                    <strong>Small</strong>: The minified code is less than 20kB
                    and the CDN compressed code is less than 1kB while the
                    entire package raw is less than 70kB.
                </li>
                <li>
                    <strong>Simple</strong>: With just two core APIs, learning
                    it is pretty straight forward even so if you already know
                    JavaScript and HTML. Everything else, which is not much, is
                    to aid with templating.
                </li>
                <li>
                    <strong>Client & Server</strong>: The templating system is
                    environment agnostic which allows it to run in any
                    Javascript environment without additional setup.
                </li>
            </ul>
            ...
            <p>
                ...
                used. Also, none of them take care of DOM changes and are too
                simple to build full system just with them alone. Let's look at
                few examples:
            </p>
            <ul>
                <li>
            ...
            <details>
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        period tested by different developers both in
                    ...
                    <dd>
                        ...
                        client and server. Tests have not been completed in
                        other environments yet but the goal is to make it
                        available anywhere.
                    </dd>
                </dl>
            </details>
