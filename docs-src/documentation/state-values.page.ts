    ...
    DocPageLayout(
        ...
        html`
            ...
            <p>
                ...
                is an optimal way to work with template values that you expect
                to change and that the template should react to.
            </p>
            ${CodeSnippet(
            ...
            <p>
                ...
                state concept you might have heard of. It is part of the
                template system rather than some specific utility.
            </p>
            <p>
            ...
            <ul>
                ...
                <li>
                    ...
                    unsubscribe from the state in case you provided a
            ...
            <p>
                ...
                function that uses that state inside will not get called when
                that state changes because the template cannot see state inside
                your function.
            </p>
            ${CodeSnippet(
                'const counter = html`\n' +
            ...
            <p>
                ...
                <a href="./what-is-a-helper">helpers</a> in the next section of
                the doc.
            </p>
            ${DocPrevNextNav({
                prev: prevPage,
