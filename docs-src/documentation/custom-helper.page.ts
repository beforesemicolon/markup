...
export default DocPageLayout(
    ...
    html`
        ...
        <p>
            ...
            <code>helper</code> function and handle the state value. All that
        ...
        <p>Let's build a helper that can filter the todos based on status.</p>
        <p>
        ...
        <p>All the issues are now fixed and the final result looks like so.</p>
        ${CodeSnippet(
            'const filterList = helper((list, filterer) => {\n' +
                '  return list().filter(filterer)\n' +
                '});\n\n' +
