...
describe("element",  () => {
	...
	it('should create an element with attributes', () => {
		...
		expect(el).toBeInstanceOf(HTMLDivElement)
		expect(el.outerHTML).toBe('<div id="sample" data-testid="sample"></div>')
	});
	...
	it('should create an element with attributes and text content', () => {
		...
		expect(el).toBeInstanceOf(HTMLDivElement)
		expect(el.outerHTML).toBe('<div id="sample" data-testid="sample">sample</div>')
	});
	...
	it('should create an element with attributes and html content', () => {
		...
		expect(el).toBeInstanceOf(HTMLDivElement)
		expect(el.outerHTML).toBe('<div id="sample" data-testid="sample"><span>sample</span></div>')
	});
	...
	it('should create an svg element', () => {
		const el = element("svg", {
			...
			htmlContent: '<circle cx="50" cy="50" r="40" stroke="green" stroke-width="4" fill="yellow" />',
