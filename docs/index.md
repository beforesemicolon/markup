...
::: layout landing-hero title="{{t.pages.home.content.reactive_dom}}" title2="{{t.pages.home.content.zero_build}}" primaryLabel="{{t.common.content.get_started}}" secondaryLabel="npm i @beforesemicolon/markup"
